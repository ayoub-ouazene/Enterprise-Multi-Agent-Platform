...
export function OnboardingWizard() {
  ...
  return <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
    <header className="border-b border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900"><div className="mx-auto flex min-h-16 max-w-7xl items-center justify-between px-4 sm:px-6"><div><p className="font-bold">Orchestra</p><p className="text-xs text-neutral-500">Company setup</p></div><Button variant="ghost" onClick={() => { clearSensitiveSession(auth.logout); navigate('/login', { replace: true }); }}><LogOut size={16} className="mr-2" />Save and exit</Button></div></header>
